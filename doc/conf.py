...
copyright = u'2012, Stefano Borini, Benjamin Golder'
...
latex_documents = [
  ('index', 'python-geometry.tex', u'python-geometry Documentation',
   u'Stefano Borini, Benjamin Golder', 'manual'),
]
...
man_pages = [
    ('index', 'python-geometry', u'python-geometry Documentation',
     [u'Stefano Borini, Benjamin Golder'], 1)
]
...
texinfo_documents = [
  ('index', 'python-geometry', u'python-geometry Documentation',
   u'Stefano Borini, Benjamin Golder', 'python-geometry', 'One line description of project.',
   'Miscellaneous'),
]
